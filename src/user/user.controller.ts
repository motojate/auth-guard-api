...
import { CheckAvailabilityUserIdDto, SignUpMemberUserDto } from './dtos/user.dto';
...
export class UserController {
  ...
  @HttpCode(200)
  async isavailAbilityUserId(@Query() checkAvailabilityUserIdDto: CheckAvailabilityUserIdDto) {
